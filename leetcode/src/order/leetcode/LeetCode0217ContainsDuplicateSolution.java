 ...
 * @author tengxq
 */
public class LeetCode0217ContainsDuplicateSolution {
    public static void main(String[] args) {
        int[] nums = new int[]{1, 1, 1, 3, 3, 4, 3, 2, 4, 2};
        LeetCode0217ContainsDuplicateSolution containsDuplicateSolution = new LeetCode0217ContainsDuplicateSolution();
