 ...
 * @author tengxq
 */
public class LeetCode0349IntersectionOfTwoArraysSolution {
    public static void main(String[] args) {
        int[] nums1 = new int[]{1, 2, 2, 1};
        int[] nums2 = new int[]{2, 2};
        LeetCode0349IntersectionOfTwoArraysSolution intersectionOfTwoArraysSolution = new LeetCode0349IntersectionOfTwoArraysSolution();
