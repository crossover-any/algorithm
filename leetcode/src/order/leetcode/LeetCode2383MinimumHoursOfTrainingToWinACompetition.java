 ...
 * @author tengxq
 */
public class LeetCode2383MinimumHoursOfTrainingToWinACompetition {

    public static void main(String[] args) {
        System.out.println(new LeetCode2383MinimumHoursOfTrainingToWinACompetition().minNumberOfHours(1,1, new int[]{1,1,1,1}, new int[]{1,1,1,50}));
    }
