 ...
 * @author tengxq
 */
public class LeetCode0088MergeSortedArraySolution {
    public static void main(String[] args) {
        int[] nums1 = new int[]{1,2,3,0,0,0};
        int[] nums2 = new int[]{2,5,6};
        LeetCode0088MergeSortedArraySolution mergeSortedArraySolution = new LeetCode0088MergeSortedArraySolution();
